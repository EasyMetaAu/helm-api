...
const ROWS: Row[] = [
  ...
  // — generic complexity policies also apply to vision/tool_use/web. —
  {
    name: "vision+simple → economy (generic simple policy)",
    task_type: "vision",
    complexity: "simple",
    matched_policy_id: "policy[9]",
    selected_lane: "economy",
  ...
  {
    name: "tool_use+complex → premium (generic complex policy)",
    task_type: "tool_use",
    complexity: "complex",
    matched_policy_id: "policy[11]",
    selected_lane: "premium",
    decided_by: "policy",
  },
  {
