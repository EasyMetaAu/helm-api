...
<div class="flex h-screen overflow-hidden bg-slate-50 text-slate-900">
  ...
  >
    ...
    <div class="space-y-3 border-t border-slate-100 px-4 py-4">
      ...
      <!-- Project source link. "GitHub" is a brand name, so it is not localized. -->
      <a
        href="https://github.com/EasyMetaAu/helm-api"
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center gap-2 px-1 text-xs text-slate-400 transition-colors hover:text-slate-700"
      >
