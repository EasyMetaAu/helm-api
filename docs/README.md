...
| 12 | [Memory: Forgetting & Tiering](12-memory-forgetting-and-tiering.md) | **Proposed.** Short/mid/long-term tiers + a deterministic forgetting strategy (decay, reinforcement, soft-archive, supersede) layered on 08. |
