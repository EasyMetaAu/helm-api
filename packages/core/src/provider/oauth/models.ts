...
// so the default tracks the latest codex `rust-vX.Y.Z` release tag and is
// regenerated by `pnpm sync:codex-models` alongside the bundled catalog; alpha
// suffixes are intentionally omitted, matching codex-rs/models-manager::client_version_to_whole.
export { DEFAULT_OPENAI_CODEX_CLIENT_VERSION };
