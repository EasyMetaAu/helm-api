...
and aged out by the independent scheduled cleanup runner when payload cleanup is
enabled (`payload_retention_days`, 30 by default). Redacted telemetry has its own
