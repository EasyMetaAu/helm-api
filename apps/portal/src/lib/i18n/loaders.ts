...
const loaders: Record<LocaleCode, () => Promise<TranslationDict>> = {
  en: async () =>
    (await import("../../locales/en.json")).default as TranslationDict,
  "zh-hans": async () =>
    (await import("../../locales/zh-hans.json")).default as TranslationDict,
  "zh-hant": async () =>
    (await import("../../locales/zh-hant.json")).default as TranslationDict,
  ja: async () =>
    (await import("../../locales/ja.json")).default as TranslationDict,
  ko: async () =>
    (await import("../../locales/ko.json")).default as TranslationDict,
  es: async () =>
    (await import("../../locales/es.json")).default as TranslationDict,
  pt: async () =>
    (await import("../../locales/pt.json")).default as TranslationDict,
};
